...
// PinchePlan
public class PinchePlanDto implements Serializable {
	// id
	private long id;
	// 集合地址
	...
	private int planUsersNum;
	private List<PlanUsersDto> planUsersList;
	...
	public String getGoDateYYYYMMDD() {
		return goDateYYYYMMDD;
	}

	public void setGoDateYYYYMMDD(String goDateYYYYMMDD) {
		this.goDateYYYYMMDD = goDateYYYYMMDD;
	}

	public int getPlanUsersNum() {
		return planUsersNum;
	}

	public void setPlanUsersNum(int planUsersNum) {
		this.planUsersNum = planUsersNum;
	}

	public List<PlanUsersDto> getPlanUsersList() {
		return planUsersList;
	}

	public void setPlanUsersList(List<PlanUsersDto> planUsersList) {
		this.planUsersList = planUsersList;
	}
