...
public class UserDaoImpl extends BaseDao implements UserDao {
    ...
    public boolean saveUserBaseInfo(BaseInfo baseInfo) {
        ...
        try {
            BeanUtils.copyProperties(baseInfo,userSetting);
            BeanUtils.copyProperties(baseInfo,userProfile);
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     */
    @Override
    public BaseInfo login(BaseInfo baseInfo) {
        return (BaseInfo)super.queryForObject("UserMapper.login", baseInfo);
    }
    ...
    public boolean mobileCount(BaseInfo baseInfo) {
        return super.queryCountForObject("UserMapper.mobileCount", baseInfo) > 0;
    }
    ...
    /**
     * 查询email下的用户所有信息 不带pci
     * author dingrc
     * @param email
     * @return
     */
    public UserInfo queryUserInfoByEmailNoPic(String email) {
        return (UserInfo) super.queryForObject("UserMapper.queryUserInfoByEmailNoPic",email);
    }
    ...
    public UserInfo queryUserInfoByUserId(Integer id){
        ...
        return (UserInfo) super.queryForObject("UserMapper.queryUserInfoByUserId",id);
    }
    ...
    public boolean updateUserSettingLocationInfo(UserSetting userSetting) {
        return super.update("UserMapper.updateUserSettingLocationInfo",userSetting);
    }
    ...
    public List<UserSetting> pageQueryCriteria(UserSettingCriteria criteria){
        return queryForList("UserMapper.pageQueryCriteria", criteria);
    }

    public long pageQueryCriteriaCount(UserSettingCriteria criteria){
        Long count= (Long)super.queryForObject("UserMapper.pageQueryCriteriaCount",criteria);
        return count;
    }
    public boolean updateUserPwd(BaseInfo baseInfo) {
        return super.update("UserMapper.updateUserPwd",baseInfo);
    }
}
